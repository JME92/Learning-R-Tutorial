...
<aside>
In the above code, you can see code comments. In R, comments are designated by a hash mark (#; or "hashtag" as the kids call 'em). Anything after the hash mark will be ignored by R. But they won't be ignored by people! Use comments often; it will greatly benefit your future self, when you go back in six months and wonder what you were trying to do. It will also benefit anyone else who reads your code, if you share it with others. Try to be explanatory with your comments -- talk about what the purpose of the code is, rather than just describing exactly what it does. But when you're starting out with programming, lots of comments are good :)
</aside>
