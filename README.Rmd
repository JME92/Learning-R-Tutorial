...
11. *Special Topics: Structural Equation Modelling*
12. *Other Packages to Check Out*
13. *Getting the Most Out of R*

[comment]: # (TODO: Add logical vectors, conditionals, and ifelse() to lesson 4)
[comment]: # (TODO: Add if-else structure to lesson 8)
