...
data$startDateTime <- strptime(paste(data$startDate, data$startTime), format="%d/%m/%Y %H:%M:%S")
data$endDateTime <- strptime(paste(data$endDate, data$endTime), format="%d/%m/%Y %H:%M:%S")
...
```{r dplyr2, results="hide"}
data[data$frustration > 4, ]
